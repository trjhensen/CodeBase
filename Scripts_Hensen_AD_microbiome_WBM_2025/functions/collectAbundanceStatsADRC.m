function mergedTaxa = collectAbundanceStatsADRC(paths, fileNames)
...
oldNames = {'Ruminococcus_chamellensis'};%,'Comilactobacillus_farciminis'};
nameRepairs = {'Ruminococcus_champanellensis'};%,'Companilactobacillus_farciminis'}';
...
mergedTaxa = sortrows(mergedTaxa,"mean_premapped",'descend');
end